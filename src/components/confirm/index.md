...
| popConfirmProps | popConfirm 相关属性                  | [PopconfirmProps](https://ant.design/components/popconfirm-cn#api)    | null                 |
| buttonProps     | Button 相关 (不传 children 内容生效) | [ButtonProps](https://ant.design/components/popconfirm-cn#api)        | null                 |
| modalProps      | Modal 组件 相关                      | [modalProps](https://ant-design.antgroup.com/components/modal-cn#api) | null                 |
